...
int main(int argc, char **argv)
{
  if (argc != 2)
  {
    std::cerr << "Usage: ./bin/benchmark_nw <num_seqs>\n";
    return 1;
  }
  ...
  // Data for Custom Implementations (Integers)
  ...
  // This pays the 200ms CUDA context initialization tax safely!
  nwGPU(dummy_scores, dummy_query, dummy_db, dummy_offsets);
