#include "sw_parasail.h"
#include "parasail/matrices/blosum62.h"

void swParasail(std::vector<int> &cpu_scores, const std::string &query, const std::vector<std::string> &db_ascii)
{
  ...
  {
    // Run the Needleman-Wunsch 'scan' algorithm (the fastest SIMD approach for SW)
